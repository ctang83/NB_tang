...
Stata figure出图终极解决方案--使用Ghostscript-gswin64c.exe：win10环境下安装Ghostscript, [Step I](https://mile.com/assets/documents/Installing-Ghostscript-on-Windows-10.pdf). 
win10环境下根据[Step II](https://www.architectryan.com/2018/03/17/add-to-the-path-on-windows-10/)添加
"C:\Program Files\gs926\bin"
