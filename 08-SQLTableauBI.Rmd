...
![Stata中ODBC查询](figs/fig_ODBC1.jpg){width=60%}

然后，添加后点击对应的数据目录，本次安装在home2，然后进行数据添加。
![Stata中ODBC查询](figs/fig_ODBC2.jpg){width=60%}
...
![Stata中ODBC查询](figs/fig_ODBC3.jpg){width=60%}

```r
odbc list //Stata通过ODBC查询调用任意SQL数据
help odbc
```
![Stata中ODBC查询](figs/fig_ODBC_stata.jpg){width=60%}
