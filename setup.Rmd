...
## Create "awesome-book" GitHub repo
...
1. It should say "Your site is ready to be published at https://username.github.io/awesome-book/"

## Write local .Rmd files, update Github online book

1. Rstudio to build the book 
1. commit all files, including the docs/ folder, online book will be updated!

1. In Console, type `rmarkdown::render_site(encoding = 'UTF-8')`
