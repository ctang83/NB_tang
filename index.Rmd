...
What is a [value-based health care system](https://veradigm.com/what-is-value-based-healthcare/)?  

1. Value-based healthcare is **a healthcare delivery framework that incentivizes healthcare providers to focus on the quality of services rendered, as opposed to the quantity**. 
1. Under a value-based healthcare model, healthcare providers (including hospitals and physicians) are compensated based upon patient health outcomes.
